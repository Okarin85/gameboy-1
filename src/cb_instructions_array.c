...
const t_cb_instruction		g_cb_instructions[MAX_CB_INSTRUCTION + 1] = {
    ...
    */
    ...
    [0x37] = {"SWAP A, A",		&cb_instr_swap_a_a,	4},
    [0x30] = {"SWAP A, B",		&cb_instr_swap_a_b,	4},
    [0x31] = {"SWAP A, C",		&cb_instr_swap_a_c,	4},
    [0x32] = {"SWAP A, D",		&cb_instr_swap_a_d,	4},
    [0x33] = {"SWAP A, E",		&cb_instr_swap_a_e,	4},
    [0x34] = {"SWAP A, H",		&cb_instr_swap_a_h,	4},
    [0x35] = {"SWAP A, L",		&cb_instr_swap_a_l,	4},
    [0x36] = {"SWAP A, (HL)",		&cb_instr_swap_a_hlp,	8},
    ...
    */
    ...
    [0x46] = {"BIT 0, (HL)",		&cb_instr_bit_0_hlp,	16},
    ...
    [0x4E] = {"BIT 1, (HL)",		&cb_instr_bit_1_hlp,	16},
    ...
    [0x56] = {"BIT 2, (HL)",		&cb_instr_bit_2_hlp,	16},
    ...
    [0x5E] = {"BIT 3, (HL)",		&cb_instr_bit_3_hlp,	16},
    ...
    [0x66] = {"BIT 4, (HL)",		&cb_instr_bit_4_hlp,	16},
    ...
    [0x6E] = {"BIT 5, (HL)",		&cb_instr_bit_5_hlp,	16},
    ...
    [0x76] = {"BIT 6, (HL)",		&cb_instr_bit_6_hlp,	16},
    ...
    [0x7E] = {"BIT 7, (HL)",		&cb_instr_bit_7_hlp,	16},
