...
const t_instruction		g_instructions[MAX_INSTRUCTION + 1] = {
    ...
    */
    ...
    [0x78] = {"LD A, B",		&instr_ld_a_b,		0,	4},
    [0x79] = {"LD A, C",		&instr_ld_a_c,		0,	4},
    [0x7A] = {"LD A, D",		&instr_ld_a_d,		0,	4},
    [0x7B] = {"LD A, E",		&instr_ld_a_e,		0,	4},
    [0x7C] = {"LD A, H",		&instr_ld_a_h,		0,	4},
    [0x7D] = {"LD A, L",		&instr_ld_a_l,		0,	4},
    [0x7E] = {"LD A, (HL)",		&instr_ld_a_hl,		0,	8},

    [0x40] = {"LD B, B",		&instr_ld_b_b,		0,	4},
    [0x41] = {"LD B, C",		&instr_ld_b_c,		0,	4},
    [0x42] = {"LD B, D",		&instr_ld_b_d,		0,	4},
    [0x43] = {"LD B, E",		&instr_ld_b_e,		0,	4},
    [0x44] = {"LD B, H",		&instr_ld_b_h,		0,	4},
    [0x45] = {"LD B, L",		&instr_ld_b_l,		0,	4},
    [0x46] = {"LD B, (HL)",		&instr_ld_b_hl,		0,	8},

    [0x48] = {"LD C, B",		&instr_ld_c_b,		0,	4},
    [0x49] = {"LD C, C",		&instr_ld_c_c,		0,	4},
    [0x4A] = {"LD C, D",		&instr_ld_c_d,		0,	4},
    [0x4B] = {"LD C, E",		&instr_ld_c_e,		0,	4},
    [0x4C] = {"LD C, H",		&instr_ld_c_h,		0,	4},
    [0x4D] = {"LD C, L",		&instr_ld_c_l,		0,	4},
    [0x4E] = {"LD C, (HL)",		&instr_ld_c_hl,		0,	8},

    [0x50] = {"LD D, B",		&instr_ld_d_b,		0,	4},
    [0x51] = {"LD D, C",		&instr_ld_d_c,		0,	4},
    [0x52] = {"LD D, D",		&instr_ld_d_d,		0,	4},
    [0x53] = {"LD D, E",		&instr_ld_d_e,		0,	4},
    [0x54] = {"LD D, H",		&instr_ld_d_h,		0,	4},
    [0x55] = {"LD D, L",		&instr_ld_d_l,		0,	4},
    [0x56] = {"LD D, (HL)",		&instr_ld_d_hl,		0,	8},

    [0x58] = {"LD E, B",		&instr_ld_e_b,		0,	4},
    [0x59] = {"LD E, C",		&instr_ld_e_c,		0,	4},
    [0x5A] = {"LD E, D",		&instr_ld_e_d,		0,	4},
    [0x5B] = {"LD E, E",		&instr_ld_e_e,		0,	4},
    [0x5C] = {"LD E, H",		&instr_ld_e_h,		0,	4},
    [0x5D] = {"LD E, L",		&instr_ld_e_l,		0,	4},
    [0x5E] = {"LD E, (HL)",		&instr_ld_e_hl,		0,	8},

    [0x60] = {"LD H, B",		&instr_ld_h_b,		0,	4},
    [0x61] = {"LD H, C",		&instr_ld_h_c,		0,	4},
    [0x62] = {"LD H, D",		&instr_ld_h_d,		0,	4},
    [0x63] = {"LD H, E",		&instr_ld_h_e,		0,	4},
    [0x64] = {"LD H, H",		&instr_ld_h_h,		0,	4},
    [0x65] = {"LD H, L",		&instr_ld_h_l,		0,	4},
    [0x66] = {"LD H, (HL)",		&instr_ld_h_hl,		0,	8},

    [0x68] = {"LD L, B",		&instr_ld_l_b,		0,	4},
    [0x69] = {"LD L, C",		&instr_ld_l_c,		0,	4},
    [0x6A] = {"LD L, D",		&instr_ld_l_d,		0,	4},
    [0x6B] = {"LD L, E",		&instr_ld_l_e,		0,	4},
    [0x6C] = {"LD L, H",		&instr_ld_l_h,		0,	4},
    [0x6D] = {"LD L, L",		&instr_ld_l_l,		0,	4},
    [0x6E] = {"LD L, (HL)",		&instr_ld_l_hl,		0,	8},

    [0x70] = {"LD (HL), B",		&instr_ld_hl_b,		0,	8},
    [0x71] = {"LD (HL), C",		&instr_ld_hl_c,		0,	8},
    [0x72] = {"LD (HL), D",		&instr_ld_hl_d,		0,	8},
    ...
    [0x4F] = {"LD C, A",		&instr_ld_c_a,		0,	4},
    [0x57] = {"LD D, A",		&instr_ld_d_a,		0,	4},
    [0x5F] = {"LD E, A",		&instr_ld_e_a,		0,	4},
    [0x67] = {"LD H, A",		&instr_ld_h_a,		0,	4},
    [0x6F] = {"LD L, A",		&instr_ld_l_a,		0,	4},
    ...
    */
    ...
    [0xF5] = {"PUSH AF",		&instr_push_af,		0,	16},
    [0xC5] = {"PUSH BC",		&instr_push_bc,		0,	16},
    [0xD5] = {"PUSH DE",		&instr_push_de,		0,	16},
    [0xE5] = {"PUSH HL",		&instr_push_hl,		0,	16},

    // POP r : pop two bytes off stack into register pair r. Increment SP twice.
    [0xF1] = {"POP AF",			&instr_pop_af,		0,	12},
    [0xC1] = {"POP BC",			&instr_pop_bc,		0,	12},
    [0xD1] = {"POP DE",			&instr_pop_de,		0,	12},
    [0xE1] = {"POP HL",			&instr_pop_hl,		0,	12},
    ...
    */
    ...
    // ADD A, r : add r to A.
    [0x87] = {"ADD A, A",		&instr_add_a_a,		0,	4},
    [0x80] = {"ADD A, B",		&instr_add_a_b,		0,	4},
    [0x81] = {"ADD A, C",		&instr_add_a_c,		0,	4},
    [0x82] = {"ADD A, D",		&instr_add_a_d,		0,	4},
    [0x83] = {"ADD A, E",		&instr_add_a_e,		0,	4},
    ...
    [0x88] = {"ADC A, B",		&instr_adc_a_b,		0,	4},
    [0x89] = {"ADC A, C",		&instr_adc_a_c,		0,	4},
    [0x8A] = {"ADC A, D",		&instr_adc_a_d,		0,	4},
    [0x8B] = {"ADC A, E",		&instr_adc_a_e,		0,	4},
    ...
    [0x90] = {"SUB A, B",		&instr_sub_a_b,		0,	4},
    [0x91] = {"SUB A, C",		&instr_sub_a_c,		0,	4},
    [0x92] = {"SUB A, D",		&instr_sub_a_d,		0,	4},
    [0x93] = {"SUB A, E",		&instr_sub_a_e,		0,	4},
    ...
    [0x98] = {"SBC A, B",		&instr_sbc_a_b,		0,	4},
    [0x99] = {"SBC A, C",		&instr_sbc_a_c,		0,	4},
    [0x9A] = {"SBC A, D",		&instr_sbc_a_d,		0,	4},
    [0x9B] = {"SBC A, E",		&instr_sbc_a_e,		0,	4},
    ...
    [0xA0] = {"AND A, B",		&instr_and_a_b,		0,	4},
    [0xA1] = {"AND A, C",		&instr_and_a_c,		0,	4},
    [0xA2] = {"AND A, D",		&instr_and_a_d,		0,	4},
    [0xA3] = {"AND A, E",		&instr_and_a_e,		0,	4},
    ...
    [0xB0] = {"OR A, B",		&instr_or_a_b,		0,	4},
    [0xB1] = {"OR A, C",		&instr_or_a_c,		0,	4},
    [0xB2] = {"OR A, D",		&instr_or_a_d,		0,	4},
    [0xB3] = {"OR A, E",		&instr_or_a_e,		0,	4},
    ...
    [0xA8] = {"XOR A, B",		&instr_xor_a_b,		0,	4},
    [0xA9] = {"XOR A, C",		&instr_xor_a_c,		0,	4},
    [0xAA] = {"XOR A, D",		&instr_xor_a_d,		0,	4},
    [0xAB] = {"XOR A, E",		&instr_xor_a_e,		0,	4},
    ...
    [0xB8] = {"CP A, B",		&instr_cp_a_b,		0,	4},
    [0xB9] = {"CP A, C",		&instr_cp_a_c,		0,	4},
    [0xBA] = {"CP A, D",		&instr_cp_a_d,		0,	4},
    [0xBB] = {"CP A, E",		&instr_cp_a_e,		0,	4},
    ...
    [0x04] = {"INC A, B",		&instr_inc_a_b,		0,	4},
    [0x0C] = {"INC A, C",		&instr_inc_a_c,		0,	4},
    [0x14] = {"INC A, D",		&instr_inc_a_d,		0,	4},
    [0x1C] = {"INC A, E",		&instr_inc_a_e,		0,	4},
    [0x24] = {"INC A, H",		&instr_inc_a_h,		0,	4},
    [0x2C] = {"INC A, L",		&instr_inc_a_l,		0,	4},
    [0x34] = {"INC A, (HL)",		&instr_inc_a_hlp,	0,	12},

    // DEC r : decrement register n.
    [0x3D] = {"DEC A, A",		&instr_dec_a_a,		0,	4},
    [0x05] = {"DEC A, B",		&instr_dec_a_b,		0,	4},
    [0x0D] = {"DEC A, C",		&instr_dec_a_c,		0,	4},
    [0x15] = {"DEC A, D",		&instr_dec_a_d,		0,	4},
    [0x1D] = {"DEC A, E",		&instr_dec_a_e,		0,	4},
    [0x25] = {"DEC A, H",		&instr_dec_a_h,		0,	4},
    [0x2D] = {"DEC A, L",		&instr_dec_a_l,		0,	4},
    [0x35] = {"DEC A, (HL)",		&instr_dec_a_hlp,	0,	12},
    ...
    */
    ...
    [0x09] = {"ADD HL, BC",		&instr_add_hl_bc,	0,	8},
    [0x19] = {"ADD HL, DE",		&instr_add_hl_de,	0,	8},
    [0x29] = {"ADD HL, HL",		&instr_add_hl_hl,	0,	8},
    ...
    [0x13] = {"INC DE",			&instr_inc_de,		0,	8},
    [0x23] = {"INC HL",			&instr_inc_hl,		0,	8},
    [0x33] = {"INC SP",			&instr_inc_sp,		0,	8},

    // DEC rr : decrement register rr.
    [0x0B] = {"DEC BC",			&instr_dec_bc,		0,	8},
    [0x1B] = {"DEC DE",			&instr_dec_de,		0,	8},
    [0x2B] = {"DEC HL",			&instr_dec_hl,		0,	8},
    [0x3B] = {"DEC SP",			&instr_dec_sp,		0,	8},
    ...
    */
    ...
    [0x07] = {"RLCA",			&instr_rlca,		0,	4},

    // RLA : rotate A left through Carry flag.
    [0x17] = {"RLA",			&instr_rla,		0,	4},

    // RRCA : rotate A right. Old bit 0 to Carry flag.
    [0x0F] = {"RRCA",			&instr_rrca,		0,	4},

    // RRA : rotate A right through Carry flag.
    [0x1F] = {"RRA",			&instr_rra,		0,	4},
    ...
    */
    ...
    [0xC7] = {"RST 0x00",		&instr_rst_00,		0,	32},
    [0xCF] = {"RST 0x08",		&instr_rst_08,		0,	32},
    [0xD7] = {"RST 0x10",		&instr_rst_10,		0,	32},
    [0xDF] = {"RST 0x18",		&instr_rst_18,		0,	32},
    [0xE7] = {"RST 0x20",		&instr_rst_20,		0,	32},
    [0xEF] = {"RST 0x28",		&instr_rst_28,		0,	32},
    [0xF7] = {"RST 0x30",		&instr_rst_30,		0,	32},
    [0xFF] = {"RST 0x38",		&instr_rst_38,		0,	32},
    ...
    */
    ...
    // cond = NC, Jump if C flag is reset.
    // cond = C,  Jump if C flag is set.
    [0xC0] = {"RET NZ",			&instr_ret_nz,		0,	8},
    [0xC8] = {"RET Z",			&instr_ret_z,		0,	8},
    [0xD0] = {"RET NC",			&instr_ret_nc,		0,	8},
    [0xD8] = {"RET C",			&instr_ret_c,		0,	8},

    // RETI : pop two bytes from stack & jump
    // to that address then enable interrupts.
    [0xD9] = {"RETI",			&instr_reti,		0,	8},
